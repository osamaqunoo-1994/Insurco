package com.osama.insurco.ui.StaticsPages.adapter;
 ...
 */
public class RecyclerView_faqs extends RecyclerView.Adapter<RecyclerView_faqs.MyViewHolder> {
    public static List<FaqsModules.Faq> alldata = new ArrayList<FaqsModules.Faq>();
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_faqs(Context context, List<FaqsModules.Faq> alldata) {
...
//        holder.name_priza.setText(alldata.get(position).getPrizeTitle() + "");
        holder.title.setText(alldata.get(position).getQuestion() + "");
        holder.desc.setText(alldata.get(position).getAnswer() + "");
////
////
...
//
        ...
        holder.drop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (alldata.get(position).isIs_open()) {
                    alldata.get(position).setIs_open(false);
                    holder.desc.setVisibility(View.GONE);

                    holder.drop.setImageDrawable(context.getDrawable(R.drawable.icon_ionic_ios_arrow_dropdown));
                } else {

                    alldata.get(position).setIs_open(true);
                    holder.desc.setVisibility(View.VISIBLE);
                    holder.drop.setImageDrawable(context.getDrawable(R.drawable.icon_ionic_ios_arrow_droptop));
...
//
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_faqs, parent, false);
