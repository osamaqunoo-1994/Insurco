 ...
 */
public class RecyclerView_ordermator extends RecyclerView.Adapter<RecyclerView_ordermator.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_ordermator(Context context, List<Orders.Item> alldata) {
