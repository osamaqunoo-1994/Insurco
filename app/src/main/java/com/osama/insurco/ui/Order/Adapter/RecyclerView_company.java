...
import com.osama.insurco.Modules.Companys;
 ...
 */
public class RecyclerView_company extends RecyclerView.Adapter<RecyclerView_company.MyViewHolder> {
    public static List<Orders.Company_> alldata = new ArrayList<Orders.Company_>();
...
//        TextView title_category;
        ...
        public MyViewHolder(View view) {
            ...
            naame = view.findViewById(R.id.naame);
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_company(Context context, List<Orders.Company_> alldata) {
...
//        holder.name_priza.setText(alldata.get(position).getPrizeTitle() + "");
        holder.naame.setText(alldata.get(position).getCompanyInsurance().getName() + "");
        holder.price.setText(alldata.get(position).getInsurancePolicyPrice() + "");
//
//
