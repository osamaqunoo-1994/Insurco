 ...
 */
public class RecyclerView_health_ins extends RecyclerView.Adapter<RecyclerView_health_ins.MyViewHolder> {
    public static List<MotoTypeInsuranceModules.InsurancesType> alldata = new ArrayList<MotoTypeInsuranceModules.InsurancesType>();
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_health_ins(Context context, List<MotoTypeInsuranceModules.InsurancesType> alldata) {
...
//
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, NewOrderHelthActivity.class);
...
//
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_insu, parent, false);
