...
public class takeDoubleImgActivity extends BaseActivity {
    TextView next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        front_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("999989889898989898989111111"+type_front_or_back);



                if (ContextCompat.checkSelfPermission(takeDoubleImgActivity.this, Manifest.permission.CAMERA)
                        != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(takeDoubleImgActivity.this, new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE}, 10);

                    // Permission is not granted
                } else {
                    System.out.println("999989889898989898989111111");

                    int check = ActivityCompat.checkSelfPermission(takeDoubleImgActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                    if (check == PackageManager.PERMISSION_GRANTED) {
                        //Do something
//                        startActivity(new Intent(takeDoubleImgActivity.this, TakeImageCameraActivitynew23.class));
                        com.github.dhaval2404.imagepicker.ImagePicker.Builder builder = new com.github.dhaval2404.imagepicker.ImagePicker.Builder(takeDoubleImgActivity.this);
                        builder.crop()
                                .cameraOnly()	//User can only capture image using Camera
                                .compress(1024)            //Final image size will be less than 1 MB(Optional)
                                .start();
                    } else {
                        ActivityCompat.requestPermissions(takeDoubleImgActivity.this,  new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1024);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (file_front != null && file_back != null) {
                    NewOrderActivity.save_img(file_front, file_back);
                    finish();
                } else {
...
//            front_img.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_baseline_check_circle_111));
            ...
            bavk_img.setImageBitmap(BitmapFactory.decodeFile(file_back.getPath()));
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (ContextCompat.checkSelfPermission(takeDoubleImgActivity.this, Manifest.permission.CAMERA)
            ...
            builder.crop()
                    ...
                    .compress(1024)            //Final image size will be less than 1 MB(Optional)
                    .start();
//            startActivity(new Intent(takeDoubleImgActivity.this, TakeImageCameraActivity2.class));
        }
    }
}